                    ...
                    <div class="card-header">
                        ...
                        <div class="col-6 col-sm-12">
                            <div class="float-right">
                                <a class="btn btn-primary" href="{{route('company.create')}}">Create New</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            @foreach($companies as $company)
                                <tr>
                                    ...
                                    <td>{{$company->name}}</td>
                                    <td>{{$company->email}}</td>
                                    <td><img src="{{asset("storage/logos/" .$company->logo)}}"
                                             class="logoImg img-thumbnail rounded img-bordered img-size-100 mr-3 img-circle align-content-center"/>
                                    </td>
                                    <td style="max-width: 300px;">{{$company->website}}</td>
                                           ...
                                           <span>
                                               <div class="flex space-x-3 rtl:space-x-reverse">
                                                   ...
                                                   <form class="delete-object"
                                                         action="{{route('company.destroy',$company)}}" method="POST">
                                                       @csrf
                                                       @method('DELETE')
                            ...
                            <tr>
                                <td colspan="6">
                                    <div class="col-auto float-right">{{ $companies->links() }}</div>
                                </td>
                            </tr>
                            </tfoot>
                        </table>
